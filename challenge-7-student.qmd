...
replace_unlikely_values <- function(measurements, min_value, max_value) {
  ...
  measurements <- ifelse(measurements < min_value | measurements > max_value, 
                         NA, 
                         measurements)
